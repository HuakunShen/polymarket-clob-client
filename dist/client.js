...
class ClobClient {
    ...
    getPricesHistory(params) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const result = yield this.get(`${this.host}${endpoints_1.GET_PRICES_HISTORY}`, {
                params,
            });
    ...
    createBuilderApiKey() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            this.canL2Auth();
            const endpoint = endpoints_1.CREATE_BUILDER_API_KEY;
            const headerArgs = {
                method: http_helpers_1.POST,
                requestPath: endpoint,
            };
    ...
    getBuilderApiKeys() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            this.canL2Auth();
            const endpoint = endpoints_1.GET_BUILDER_API_KEYS;
            const headerArgs = {
                method: http_helpers_1.GET,
                requestPath: endpoint,
            };
    ...
    revokeBuilderApiKey() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            this.mustBuilderAuth();
            const endpoint = endpoints_1.REVOKE_BUILDER_API_KEY;
            const headerArgs = {
                method: http_helpers_1.DELETE,
                requestPath: endpoint,
            };
    ...
    get(endpoint, options) {
        var _a, _b;
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return (0, http_helpers_1.get)(endpoint, Object.assign(Object.assign({}, options), { proxy: (_a = options === null || options === void 0 ? void 0 : options.proxy) !== null && _a !== void 0 ? _a : this.proxy, proxyUrl: (_b = options === null || options === void 0 ? void 0 : options.proxyUrl) !== null && _b !== void 0 ? _b : this.proxyUrl, params: Object.assign(Object.assign({}, options === null || options === void 0 ? void 0 : options.params), { geo_block_token: this.geoBlockToken }) }));
        });
    }
    post(endpoint, options) {
        var _a, _b;
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return (0, http_helpers_1.post)(endpoint, Object.assign(Object.assign({}, options), { proxy: (_a = options === null || options === void 0 ? void 0 : options.proxy) !== null && _a !== void 0 ? _a : this.proxy, proxyUrl: (_b = options === null || options === void 0 ? void 0 : options.proxyUrl) !== null && _b !== void 0 ? _b : this.proxyUrl, params: Object.assign(Object.assign({}, options === null || options === void 0 ? void 0 : options.params), { geo_block_token: this.geoBlockToken }) }));
        });
    }
    del(endpoint, options) {
        var _a, _b;
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return (0, http_helpers_1.del)(endpoint, Object.assign(Object.assign({}, options), { proxy: (_a = options === null || options === void 0 ? void 0 : options.proxy) !== null && _a !== void 0 ? _a : this.proxy, proxyUrl: (_b = options === null || options === void 0 ? void 0 : options.proxyUrl) !== null && _b !== void 0 ? _b : this.proxyUrl, params: Object.assign(Object.assign({}, options === null || options === void 0 ? void 0 : options.params), { geo_block_token: this.geoBlockToken }) }));
        });
    }
}
